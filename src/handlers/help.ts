...
const HELP = "ابدأ من /start، ثم اختر ما تحتاجه من الأزرار.\n\nيمكنك تصفح المنتجات ومتابعة طلباتك بسهولة.";

const backToMenu = inlineKeyboard([[inlineButton("العودة للقائمة", "menu:main")]]);
